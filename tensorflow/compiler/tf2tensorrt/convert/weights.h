...
class TRT_TensorOrWeights {
 ...
 private:
  ...
  /// TODO: store shared_name or handle?
  ///  - the handle is only valid for one execution (doesn't matter?)
  ///  - the handle is what we get in a tensor
  ///  - the shared_name is on the VarHandle node
  ///  - the handle contains more than just a name
